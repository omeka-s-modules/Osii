...
CREATE TABLE osii_media (id INT UNSIGNED AUTO_INCREMENT NOT NULL, osii_item_id INT UNSIGNED NOT NULL, local_media_id INT DEFAULT NULL, snapshot_media LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', remote_media_id INT UNSIGNED NOT NULL, created DATETIME NOT NULL, modified DATETIME DEFAULT NULL, INDEX IDX_8A14960E98E475EB (osii_item_id), UNIQUE INDEX UNIQ_8A14960E790BF7ED (local_media_id), UNIQUE INDEX UNIQ_8A14960E98E475EB390DA239 (osii_item_id, remote_media_id), UNIQUE INDEX UNIQ_8A14960E98E475EB790BF7ED (osii_item_id, local_media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
CREATE TABLE osii_import (id INT UNSIGNED AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, local_item_set_id INT DEFAULT NULL, snapshot_job_id INT DEFAULT NULL, import_job_id INT DEFAULT NULL, `label` VARCHAR(255) NOT NULL, root_endpoint LONGTEXT NOT NULL, key_identity VARCHAR(32) DEFAULT NULL, key_credential VARCHAR(32) DEFAULT NULL, remote_query LONGTEXT DEFAULT NULL, snapshot_items LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', snapshot_media LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', snapshot_data_types LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', snapshot_media_ingesters LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', snapshot_media_renderers LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', snapshot_properties LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', snapshot_classes LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', snapshot_vocabularies LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', data_type_map LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)', created DATETIME NOT NULL, modified DATETIME DEFAULT NULL, snapshot_completed DATETIME DEFAULT NULL, import_completed DATETIME DEFAULT NULL, delete_removed_items TINYINT(1) NOT NULL, delete_removed_media TINYINT(1) NOT NULL, add_source_item TINYINT(1) NOT NULL, source_site LONGTEXT DEFAULT NULL, INDEX IDX_73A097067E3C61F9 (owner_id), INDEX IDX_73A09706FD0B0A79 (local_item_set_id), INDEX IDX_73A0970611143C89 (snapshot_job_id), INDEX IDX_73A0970677D1F4B1 (import_job_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
...
ALTER TABLE osii_media ADD CONSTRAINT FK_8A14960E790BF7ED FOREIGN KEY (local_media_id) REFERENCES media (id) ON DELETE CASCADE;
